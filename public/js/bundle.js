      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 8:
            ...
            (0, _alert.showAlert)('error', "".concat(_context2.t0));
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_51LheneSEQBoEvEEqyoAXlxebGJH75I6sPBkYbC9QoBbVPY4l5KvYYAyFe0iGaducMvzxISNSSfG4HogSIk1jAJ0D00IYyDOEjX'); // 1 Get checkout session from the api
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var form = new FormData(); // it is build in syntax to create a form data object in the js
...
if (bookBtn) {
  bookBtn.addEventListener('click', function (e) {
    ...
    var tourId = e.target.dataset.tourId; // here destructuring can also be done
